...
def dificultad():
    ...
    while True:
        ...
        ayuda_rect = ayuda.get_rect(topleft=(550, 400))
        ...
        if configuraciones.idioma == "español":
            ...
            texto_boton1 = fuentemid.render("Fácil", False, color_negro)
            ventana.blit(texto_boton1, (260, 150))
            texto_boton2 = fuentemid.render("Díficil", False, color_negro)
            ventana.blit(texto_boton2, (915, 150))
            texto_boton2 = fuentemid.render("Ayuda", False, color_negro)
            ventana.blit(texto_boton2, (536, 497))
           #Instrucciones Faciles
            ...
            ventana.blit(texto_seleccionar, (510, 43))
            texto_boton1 = fuentemid.render("Easy", True, color_negro)
            ventana.blit(texto_boton1, (245, 149))
            texto_boton2 = fuentemid.render("Hard", True, color_negro)
            ventana.blit(texto_boton2, (925, 150))
