...
# Cargar fondo
background = pygame.image.load("recursos/fondos/nivel3.png")
background = pygame.transform.scale(background, (WIDTH, HEIGHT))

# Cargar imágenes para el jugador y los objetos que caen
playerDerecha1 = pygame.image.load('recursos/personaje/animacionderecha/3Right1.png')
playerDerecha2 = pygame.image.load('recursos/personaje/animacionderecha/3Right2.png')
playerDerecha3 = pygame.image.load('recursos/personaje/animacionderecha/3Right3.png')
playerDerecha4 = pygame.image.load('recursos/personaje/animacionderecha/3Right4.png')
playerDerecha5 = pygame.image.load('recursos/personaje/animacionderecha/3Right5.png')
playerDerecha6 = pygame.image.load('recursos/personaje/animacionderecha/3Right6.png')


playerIzquierda1 = pygame.image.load('recursos/personaje/animacionizquierda/3Left1.png')
playerIzquierda2 = pygame.image.load('recursos/personaje/animacionizquierda/3Left2.png')
playerIzquierda3 = pygame.image.load('recursos/personaje/animacionizquierda/3Left3.png')
playerIzquierda4 = pygame.image.load('recursos/personaje/animacionizquierda/3Left4.png')
playerIzquierda5 = pygame.image.load('recursos/personaje/animacionizquierda/3Left5.png')
playerIzquierda6 = pygame.image.load('recursos/personaje/animacionizquierda/3Left6.png')
