...
extra_object6_image = pygame.transform.scale(extra_object6_image, (50, 50))

extra_object7_image = pygame.image.load("recursos/basura_recicable/libro.png")
extra_object7_image = pygame.transform.scale(extra_object7_image, (50, 50))

extra_object8_image = pygame.image.load("recursos/basura_recicable/sobre.png")
extra_object8_image = pygame.transform.scale(extra_object8_image, (50, 50))
...
def show_pause_menu():
    ...
    pause_font = pygame.font.SysFont("PixAntiqua", 100)
