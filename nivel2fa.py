...
# Cargar fondo
background = pygame.image.load("recursos/fondos/nivel2.png")
background = pygame.transform.scale(background, (WIDTH, HEIGHT))

# Cargar imágenes para el jugador y los objetos que caen
playerDerecha1 = pygame.image.load('recursos/personaje/animacionderecha/2Right1.png')
playerDerecha2 = pygame.image.load('recursos/personaje/animacionderecha/2Right2.png')
playerDerecha3 = pygame.image.load('recursos/personaje/animacionderecha/2Right3.png')
playerDerecha4 = pygame.image.load('recursos/personaje/animacionderecha/2Right4.png')
playerDerecha5 = pygame.image.load('recursos/personaje/animacionderecha/2Right5.png')
playerDerecha6 = pygame.image.load('recursos/personaje/animacionderecha/2Right6.png')


playerIzquierda1 = pygame.image.load('recursos/personaje/animacionizquierda/2Left1.png')
playerIzquierda2 = pygame.image.load('recursos/personaje/animacionizquierda/2Left2.png')
playerIzquierda3 = pygame.image.load('recursos/personaje/animacionizquierda/2Left3.png')
playerIzquierda4 = pygame.image.load('recursos/personaje/animacionizquierda/2Left4.png')
playerIzquierda5 = pygame.image.load('recursos/personaje/animacionizquierda/2Left5.png')
playerIzquierda6 = pygame.image.load('recursos/personaje/animacionizquierda/2Left6.png')

#Basura organica
extra_object1_image = pygame.image.load("recursos/basura_organica/banana.png")
extra_object1_image = pygame.transform.scale(extra_object1_image, (40, 40))

extra_object2_image = pygame.image.load("recursos/basura_organica/cascara_de_huevo.png")
extra_object2_image = pygame.transform.scale(extra_object2_image, (40, 40))

extra_object3_image = pygame.image.load("recursos/basura_organica/cascara_de_sandia.png")
extra_object3_image = pygame.transform.scale(extra_object3_image, (40, 40))
...
extra_object4_image = pygame.transform.scale(extra_object4_image, (40, 40))

extra_object5_image = pygame.image.load("recursos/basura_recicable/botella_de_vidrio.png")
extra_object5_image = pygame.transform.scale(extra_object5_image, (40, 40))

extra_object6_image = pygame.image.load("recursos/basura_recicable/lata.png")
extra_object6_image = pygame.transform.scale(extra_object6_image, (40, 40))

extra_object7_image = pygame.image.load("recursos/basura_recicable/libro.png")
extra_object7_image = pygame.transform.scale(extra_object7_image, (40, 40))

extra_object8_image = pygame.image.load("recursos/basura_recicable/sobre.png")
extra_object8_image = pygame.transform.scale(extra_object8_image, (40, 40))
...
extra_object9_image = pygame.transform.scale(extra_object9_image, (40, 40))

extra_object10_image = pygame.image.load("recursos/basura_no_recicable/bolsa_de_plastico.png")
extra_object10_image = pygame.transform.scale(extra_object10_image, (40, 40))

extra_object11_image = pygame.image.load("recursos/basura_no_recicable/telefono.png")
extra_object11_image = pygame.transform.scale(extra_object11_image, (40, 40))

extra_object12_image = pygame.image.load("recursos/basura_no_recicable/tenedor.png")
extra_object12_image = pygame.transform.scale(extra_object12_image, (40, 40))
...
def main():
    global moving_sprites, auxiliar, puntos
